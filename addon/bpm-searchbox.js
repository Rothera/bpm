        ...
        '<div id="bpm-sb-container" tabindex="100">',
          ...
          '<div id="bpm-sb-tabframe">',
            ...
            '<div id="bpm-sb-flagtab">',
              ...
              '<p class="bpm-sb-flag">For instance, <code>[](/flutterwink-invert-in)',
              ...
              '<center>Basics:</center>',
               '<center><table class="bpflagtable">',
                 '<tr>',
                   ...
                   '<th class="bpflagtable-031e"><a href="/twibeam-m" class="bpm-emote bpflag-in bpflag-m bpmote-twibeam"></a><br><center><code>-m</code></center></th>', //Known bug: Magic aura doesn't go away after closing emote box.
                 '</tr>',
               '</table></center><br>',
                ...
                '<center>Animated:</center>',
                 ...
                 '<center>Sliding:</center>',
                  ...
                  '<center>Text (use with <code>[](/txt!)</code>):</center>',
                   '<center><table class="bpflagtable">',
                     '<tr>',
                       '<th class="bpflagtable-031e"><center><a class="bpm-emote bpmote-txt_excl bpflag-blink_excl_">yay.</a></center><br><center><code>-blink!</code></center></th>',
                       '<th class="bpflagtable-031e"><center><a class="bpm-emote bpmote-txt_excl bpflag-comicsans_excl_">yay.</a></center><br><center><code>-comicsans!</code></center></th>',
