        ...
        '<div id="bpm-sb-container" tabindex="100">',
          ...
          '<div id="bpm-sb-tabframe">',
            ...
            '<div id="bpm-sb-flagtab">',
              ...
              '<p class="bpm-sb-flag">For instance, <code>[](/twibeam-invert-in)',
              '</code> generates <a class="bpm-emote bpflag-invert bpflag-in ',
              'bpmote-twibeam"></a>.</p>',
              '<p class="bpm-sb-flag">Most of the flags that can be used are listed',
              ' below:</p>',
               '<center><table class="bpflagtable">',
                 '<tr>',
                   '<th class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpmote-twibeam"></a><br><center><code>-in</code></center></th>',
                   ...
                   '<th class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-45 bpmote-twibeam"></a><br><center><code>-#</code></center></th>',
                   '<th class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-spin bpmote-twibeam"></a><br><center><code>-spin</code></center></th>',
                   '<th class="bpflagtable-yw4l"><a class="bpm-emote bpflag-in bpflag-m bpflag-m-demo bpmote-twibeam"></a><br><center><code>-m</code></center></th>',
                 '</tr>',
                 '<tr>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-_excl_spin bpmote-twibeam"></a><br><center><code>-!spin</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-xspin bpmote-twibeam"></a><br><center><code>-xspin</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-yspin bpmote-twibeam"></a><br><center><code>-yspin</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-zspin bpmote-twibeam"></a><br><center><code>-zspin</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-_excl_zspin bpmote-twibeam"></a><br><center><code>-!zspin</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-shift bpmote-twibeam"></a><br><center><code>-shift</code></center></td>',
                   '<td class="bpflagtable-yw4l"><a class="bpm-emote bpflag-in bpflag-wobble bpmote-twibeam"></a><br><center><code>-wobble</code></center></td>',
                 '</tr>',
                 '<tr>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-slide bpmote-twibeam"></a><br><center><code>-slide</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-_excl_shift bpmote-twibeam"></a><br><center><code>-!shift</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-_excl_slide bpmote-twibeam"></a><br><center><code>-!slide</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-s45 bpmote-twibeam"></a><br><center><code>-s# (speed)</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-i bpmote-twibeam"></a><br><center><code>-i</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-invert bpmote-twibeam"></a><br><center><code>-invert</code></center></td>',
                   '<td class="bpflagtable-yw4l"><a class="bpm-emote bpflag-in bpflag-sepia bpmote-twibeam"></a><br><center><code>-sepia</code></center></td>',
                 '</tr>',
                 '<tr>',
                   '<td class="bpflagtable-031e"></td>',
                   '<td class="bpflagtable-031e"></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-intensifies bpmote-twibeam"></a><br><center><code>-intensifies</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-mono bpmote-twibeam"></a><br><center><code>-mono</code></center></td>',
                   '<td class="bpflagtable-031e"><a class="bpm-emote bpflag-in bpflag-blur bpmote-twibeam"></a><br><center><code>-blur</code></center></td>',
                   '<td class="bpflagtable-031e"></td>',
                   '<td class="bpflagtable-yw4l"></td>',
                 '</tr>',
               '</table></center><br>',
              '<p class="bpm-sb-flag">Note: the <code>#</code> sign in the ',
              '<code>-#</code> and <code>-s#</code> flags can be replaced ',
              'with a number, either with a number between 1-15 or in increments ',
              'of 45 (respectively).</p>',
            '</div>',
          '</div>',
