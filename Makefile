...
build/emote-classes.css build/nsfw-emote-classes.css build/emote-map.js: bin/bpgen.py emotes/*.yaml
...
build/betterponymotes.oex: build/emote-classes.css build/nsfw-emote-classes.css build/emote-map.js opera/includes/betterponymotes.js opera/includes/* opera/*
	cd opera && zip -r ../build/betterponymotes.oex * && cd ..
	cp build/betterponymotes.oex build/betterponymotes_`bin/version.py get`.oex

opera/includes/betterponymotes.js: bin/make_opera_script.py opera/includes/betterponymotes.js.in build/emote-map.js
