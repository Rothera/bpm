...
/*
 * After some *very* informal testing, I've found that enabling most things at
 * "start" time generally gives the best performance. I assume this is because
 * using MutationObserver's while the DOM is being built for the first time is
 * a bad idea, but I can't say for sure.
 *
 * However, there doesn't seem to be anything wrong with enabling the optional
 * CSS files at start time (in fact, better for some reason), so I'll leave
 * those as they are.
 */
